...
const Register = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://scicommons-backend.onrender.com/api/user/', data,{
            headers: {
  ...
  return (
            <main className="w-full h-screen flex flex-col items-center justify-center bg-gray-700 sm:px-4">
                <div className="w-full space-y-6 text-gray-600 sm:max-w-md">
                    ...
                    <div className="bg-white shadow p-4 py-6 sm:p-6 sm:rounded-lg">
                        ...
                        >
                                ...
                                <div className="relative max-w-screen mt-2">
                                    <button className="text-gray-400 absolute right-3 inset-y-0 my-auto active:text-gray-600"
                                        onClick={() => setPasswordHidden2(!isPasswordHidden2)}
                                    >
                                        {
                                            isPasswordHidden2 ? (
                                                <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                        ...
                        <p className="text-center">Already have an account? <a href="/login" className="font-medium text-amber-600 hover:text-amber-500">Log in</a></p>
                    </div>
                </div>
            </main>
  )
