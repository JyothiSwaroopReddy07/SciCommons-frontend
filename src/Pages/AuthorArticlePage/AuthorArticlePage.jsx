  ...
  return (
    ...
    <div className="m-10 w-5/6 md:w-3/4 flex bg-white p-5 rounded-lg justify-center">
      ...
      <div className="mt-4">
        <button
          type="submit"
          className="mr-3 mb-3 text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
        >
          {loading?"Submitting...":"Submit"}
        </button>
        <button
          className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" onClick={()=>setArticleEdit(false)}
        >
          Close
        </button>
      </div>
