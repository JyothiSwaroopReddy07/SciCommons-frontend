...
const CommunityCard = ({index, onDataChange, community}) => {
    ...
    return (
    <>
                <div key={community.id} className="w-full md:w-1/3 max-w-sm p-4 bg-white shadow-md rounded-lg">
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-2xl text-green-600 font-bold mb-4">{community.Community_name}</h2>
