...
const Footer = () => {
  return (
            ...
            <div className="container p-6 mx-auto">
                <div className="lg:flex">
                    ...
                    <div className="mt-6 lg:mt-0 lg:flex-1">
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                            ...
                            <div>
                                <h3 className="text-green-400 uppercase dark:text-white">Contact</h3>
                                <span className="block mt-2 text-sm text-green-400 dark:text-green-400 hover:underline">+1 526 654 8965</span>
                                <span className="block mt-2 text-sm text-green-400 dark:text-green-400 hover:underline">example@email.com</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <p className="text-center text-green-400 dark:text-green-400">© SciCommons - All rights reserved</p>
                </div>
            </div>
        </footer>
  )
